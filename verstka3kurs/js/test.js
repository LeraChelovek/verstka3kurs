...
class Quiz {
    ...
    displayCurrentQuestion() {
        ...
        question.answers.forEach((answer, index) => {
            ...
            answerElement.addEventListener('click', () => this.handleAnswer(answer, answerElement, index));
            answersContainer.appendChild(answerElement);
        });
    }
    
    handleAnswer(selectedAnswer, answerElement, answerIndex) {
        if (this.isAnswering || this.answeredQuestions.has(this.currentQuestionIndex)) {
            return;
        }
    ...
    showEndMessage() {
        ...
        // Добавляем возможность просмотра правильных ответов
    ...
    this.shuffledQuestions.forEach((question, index) => {
        ...
        questionReview.innerHTML = `
            ...
            <div class="answer-review hidden">
                ...
                ${correctAnswer.explanation ? `<br><em>${correctAnswer.explanation}</em>` : ''}
            </div>
        `;
